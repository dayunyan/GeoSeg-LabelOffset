...
class Decoder(nn.Module):
    ...
    def forward(self, res1, res2, res3, res4, h, w):
        if self.training:
            ...
            h2 = x
            x = self.p1(x, res1)
            out = dict(h4=h4, h3=h3, h2=h2, embeddings=x)
...
class UNetFormerOutDict(nn.Module):
    def __init__(
        self,
        decode_channels=64,
        dropout=0.1,
        ...
        **kwargs
        ...
        pretrained_cfg_overlay = kwargs.get("pretrained_cfg_overlay", None)
