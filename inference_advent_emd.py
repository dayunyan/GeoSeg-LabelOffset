...
class ModelOutputAdapter(nn.Module):
    ...
    def forward(self, x):
        ...
        # 这里假设字典中你关注的输出结果对应的键是'logits'，根据实际情况修改这个键名
...
def main():
    ...
    model = ModelOutputAdapter(model)
    ...
    img_paths.sort()
    # print(img_paths)
    gt_dir = os.path.join(os.path.dirname(args.image_path), "labels")
